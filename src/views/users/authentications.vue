<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="clientip">
        <template slot-scope="scope">
          {{ scope.row.clientip }}
        </template>
      </el-table-column>
      <el-table-column label="expiretime">
        <template slot-scope="scope">
...
<script>
import { getAuthenticationsList } from '@/api/authentication'
...
export default {
  ...
  methods: {
    fetchData() {
      ...
      getAuthenticationsList(params).then(response => {
